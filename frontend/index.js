...
async function Bolt() {
    ...
    if (user.bolt) {
        ...
        saveButton.addEventListener("click", () => {
            ...
            createProduct(user.name, name, price, raktaron);
            nameInput.value = "";
            priceInput.value = "";
            location.reload();
        });
...
async function updateProduct(id, name, price, raktaron){
    try {
        ...
        console.error("Error:", error);
        alert("Hiba történt a termék frissítésekor.");
    }
}
